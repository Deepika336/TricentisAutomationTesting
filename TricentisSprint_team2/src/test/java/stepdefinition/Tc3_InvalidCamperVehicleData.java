...
@Test
public class Tc3_InvalidCamperVehicleData extends Screenshots{
	...
	@When("he enters invalid vehicle data for camper from {string} and {int}")
	public void he_enters_invalid_vehicle_data_for_camper_from_and(String SheetName, Integer RowNumber) throws InvalidFormatException, IOException, InterruptedException {
